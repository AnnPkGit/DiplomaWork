...
public static class MappingExtensions
{
    ...
    public static PaginatedList<TDestination> ToPaginatedArray<TDestination>(this IEnumerable<TDestination> enumerable, int pageNumber, int pageSize) where TDestination : class
        => PaginatedList<TDestination>.FromPaginatedArray(enumerable, pageNumber, pageSize);
